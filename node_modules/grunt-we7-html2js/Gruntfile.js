/*
 * grunt-we7-html2js
 * https://github.com/donknap/grunt-we7-html2js
 *
 * Copyright (c) 2016 WeEngine Team
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    we7_html2js: {
      ...
      index_rename_function: {
        options: {
          indexRename : function(filepath) {
            return filepath.replace('test/fixtures/', '');
          },
        },
        src: ['test/fixtures/two.tpl.html'],
        dest: 'tmp/index_rename_function.js'
      },
    },
  ...
  grunt.registerTask('test', ['clean', 'we7_html2js', 'nodeunit']);
