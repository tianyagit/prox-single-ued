...
angular.module('statisticsApp').controller('HorizontalBarCtrl', [
  '$scope',
  '$http',
  'serviceCommon',
  'config',
...
angular.module('statisticsApp').controller('statisticsSettingCtrl', [
  '$scope',
  '$http',
  'config',
  function ($scope, $http, config) {
    ...
    $scope.saveSetting = function (type) {
      switch (type) {
      case 'visit':
        $http.post(config.links.editSetting, {
...
angular.module('statisticsApp').controller('systemAccountAppAnalysisCtrl', [
  '$scope',
  '$http',
  'config',
  function ($scope, $http, config) {
...
angular.module('statisticsApp').controller('systemAccountAnalysisCtrl', [
  '$scope',
  '$http',
  'config',
  function ($scope, $http, config) {
...
angular.module('statisticsApp').controller('CurrentAccountCtrl', [
  '$scope',
  '$http',
  'config',
  function ($scope, $http, config) {
...
angular.module('statisticsApp').controller('FansStatisticeCtrl', [
  '$scope',
  '$http',
  'serviceCommon',
  'config',
  function ($scope, $http, serviceCommon, config) {
    require(['echarts'], function (echarts) {
      ...
      $scope.getFansApi = function (timeType) {
        $scope.timeType = timeType;
        $http.post(config.links.fansApi, {
          'divide_type': $scope.fansDivideType,
          'time_type': timeType,
          'daterange': $scope.dateRange
        }).success(function (data) {
          console.log(data);
