angular.module('wapeditorApp').service('serviceUpwardCompatible', [
  '$rootScope',
  '$timeout',
  'orderByFilter',
  function ($rootScope, $timeout, orderByFilter) {
    ...
    serviceUpwardCompatible.compatibility = function (activeModules) {
      ...
      for (var i in activeModules) {
        ...
        if (activeModules[i].params.baseStyle instanceof Array) {
          activeModules[i].params.baseStyle = {};
        }
        if (activeModules[i].params.borderStyle instanceof Array) {
          activeModules[i].params.borderStyle = {};
        }
        if (activeModules[i].params.shadowStyle instanceof Array) {
          activeModules[i].params.shadowStyle = {};
        }
        if (activeModules[i].params.positionStyle instanceof Array) {
          activeModules[i].params.positionStyle = {};
        }
        ...
        activeModules[i].params.animationStyle = {
          'name': activeModules[i].params.animationStyle.name,
          'speed': 1,
          'delay': 0.6
        };
        ...
        case 'notice':
          ...
          activeModules[i].params.positionStyle.width = 320;
          // 宽度
          break;
        }
        var widthStyle = '';
