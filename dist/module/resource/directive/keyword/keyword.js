...
angular.module('we7resource').controller('we7resource-keyword-controller', [
  '$scope',
  '$sce',
  'serviceResource',
  function ($scope, $sce, serviceResource) {
	...
	*/
    ...
    var loadData = function () {
      serviceResource.getResources('keyword', $scope.currentPage, true, { keyword: $scope.keyword }).then(function (data) {
