angular.module('ModuleSpecialApp').service('serviceMultiPage', ['$rootScope', 'serviceCommon', 'serviceBase', 'serviceSpecialBase', function($rootScope, serviceCommon, serviceBase, serviceSpecialBase){
