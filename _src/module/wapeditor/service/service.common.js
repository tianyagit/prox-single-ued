angular.module('wapeditorApp').service('serviceCommon', ['$window', function($window){
	var serviceCommon = {};
	...
	serviceCommon.buildDataTagBegin = function(type, params) {
		...
		var html = "\{data "+
				" func='site_widget_"+type+"' module='widget' widgetdata="+encodeURIComponent(JSON.stringify(paramsData))+" \}";
		return html;
	};
