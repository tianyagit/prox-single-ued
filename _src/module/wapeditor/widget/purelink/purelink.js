angular.module('wapeditorApp').controller('PureLinkCtrl', ['$scope', function($scope){
	$scope.changeItem = function(item){
		if(item.id == 5){
			$scope.activeItem.paddingTop = angular.copy($scope.activeItem.params.baseStyle.paddingTop); 	// 记录临时变量
