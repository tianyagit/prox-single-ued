...
angular.module('we7codeuploadApp').controller('code_upload_ctrl', ['$scope', 'config', 'codeservice','$q', '$http', function ($scope, config, codeservice, $q, $http) {
